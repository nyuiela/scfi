...
contract ReserveLogic is Ownable, Pausable {
    ...
    uint256 public FEE_PERCENTAGE = 1000;
    ...
    function calculateAccumulatedFee() internal returns (uint256 fee) {
        fee = (totalReserveBalance * FEE_PERCENTAGE) / 100;
        accumulatedFees += fee;
